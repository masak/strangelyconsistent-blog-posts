...
I rendered an image of all 12600 4x4 mazes, but it would be foolish to try to put it here in the blog post. But I can [link you to it](http://strangelyconsistent.org/blog/images/all-the-4x4-mazes.png). (Warning: 4.4 MB `.png` file.)
